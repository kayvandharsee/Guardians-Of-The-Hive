    ...
    public Insect(Tile tile, int hp) {
        ...
        if (this instanceof HoneyBee) {
            if (this.tile.getBee() != null) {
                ...
                throw new IllegalArgumentException("Cannot place a bee on the Hornet Nest");
            }
            else {
            ...
            if (!this.tile.isOnThePath()) {
                throw new IllegalArgumentException("Hornets must be placed on the path from the Hornet Nest to the Beehive");
            }
            else {
                this.tile.addInsect(this);
            }
